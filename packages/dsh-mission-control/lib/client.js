      ...
      function MissionView(props) {
        ...
        if (current) {
          ...
          side = React.createElement('div', { className: 'dsh-mission-side' },
            ...
            (task.requiredArtifacts && task.requiredArtifacts.length > 0) ? React.createElement('div', { className: 'dsh-side-section' },
              React.createElement('div', { className: 'dsh-side-label' }, '必需产物'),
              React.createElement('div', { className: 'dsh-side-empty' }, task.requiredArtifacts.join(' · ')),
            ) : null,
            task.guidance ? React.createElement('div', { className: 'dsh-side-section' },
              React.createElement('div', { className: 'dsh-side-label' }, '交接指导'),
              React.createElement('div', { className: 'dsh-side-empty' }, task.guidance),
            ) : null,
