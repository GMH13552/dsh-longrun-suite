  ...
  ctx.on('system-prompt/assemble', async (_assembly, context, next) => {
    ...
    if (routerMode === 'standard') {
      ...
      if (isSubagent) {
        ...
        const missionNote = { name: 'mission-note', order: 1, text: 'Long missions: use mission_start/mission_* tools and delegate substantive work to role subagents. After dispatching background subagents, prefer setting a schedule_reminder and ending the turn over repeated waiting.' }
